      ...
      <div class="main-container" style="margin-left: 30px; margin-right: 30px">
        <div class="up-home-page-header">
          <div class="header-content">
            ...
            <div class="setting-icons">
              <van-icon name="setting-o" class="dot" @click="teSetting" />
        ...
        <div class="shortcut">
          <div class="btn-box" @click="toReceive">
            <div class="btn">
              <van-icon name="cash-on-deliver" size="30" />
            </div>
            <div>Receive</div>
          </div>
          <div class="btn-box" @click="toSend">
            <div class="btn">
              <van-icon size="40" color="#1989fa" name="cash-back-record" />
            </div>
            <div>Send</div>
          </div>
        ...
        <van-tabs v-model:active="boxactive">
              ...
              <div class="top">
                <div class="up-token index">
                  ...
                  <div class="index">
                    ...
                    <div class="index-subtitle">{{ item.subtitle }}</div>
                    <!---->
                  </div>
                </div>
                <div class="balance">
                  <div style="">{{ hideInfo(item.count) }}</div>
                </div>
              </div>
              <!---->
            </div>
            <van-empty v-else image="search" description="None coin  yet" />
          </van-tab>
          <van-tab title="Transaction History">
            ...
            <van-empty v-else image="search" description="None history yet" />
          </van-tab>
        </van-tabs>
      </div>
    </div>
